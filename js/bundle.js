...
function slider({conteiner, slide, nextArrow, prewArow, totalCounter,curentCounter, wrapper, field}) {
    //slider

    const slides = document.querySelectorAll(slide),
        slider = document.querySelector(conteiner),
        prev = document.querySelector(prewArow),
    ...
    indicators.classList.add("carousel-indicarors");
